classdef FfmpegVideoWriter16bit < dynamicprops
    %FfmpegVideoWriter16bit Create a FFmpeg Video Writer object.
    %
    %   Note: Requires MATLAB R2016b and later (Due to usage of MATLAB functions like "isstring").
    %
    %   OBJ = FfmpegVideoWriter16bit(FILENAME) constructs a FfmpegVideoWriter16bit object to
    ...
    %    
    %   Execution stages:
    %   1. Create FfmpegVideoWriter16bit object.
    %      Example: v = FfmpegVideoWriter16bit('output.mp4');
    ...
    methods (Access = public)
        ...
        % Construct
        function obj = FfmpegVideoWriter16bit(filename)
            if nargin < 1
            ...
            obj.prop_listener = addlistener(obj, observable_properties, 'PreSet', @FfmpegVideoWriter16bit.handlePropEvents);
        ...
        function open(obj)
            ...
            if length(obj) > 1
                error('OBJ must be a 1x1 FfmpegVideoWriter16bit object.');
            end
        ...
        function writeFrame(obj, I)
            ...
            if ~obj.is_write_frame_called
                ...
                try
                    ...
                    FfmpegVideoWriter16bit.registerFfmpegProcess(obj.cmd, obj.p);
                catch e
            ...
            if (p_stderr_bytes_available > 0)
                ...
                out = FfmpegVideoWriter16bit.read_BufferedInputStream(obj.p_stderr);
        ...
        function close(obj)
            ...
            FfmpegVideoWriter16bit.unregisterFfmpegProcess(obj.cmd);
    ...
    methods(Static, Access=protected)
        ...
        function handlePropEvents(src, evnt)
            ...
            warning([src.Name, ' property is modified while FfmpegVideoWriter16bit is "opened".']);
        end
